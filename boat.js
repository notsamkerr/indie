                            ...
                            if(typeof user !== 'boolean'){
                                ...
                                if(rank !== null && plugUser.permission <= rank){
                                    ...
                                    if (inactivity > esBot.roomSettings.maximumAfk * 60 * 1000 ){
                                        if(warncount === 0){
                                            API.sendChat('@' + name + ', you have been afk for ' + time + ', please respond within 2 minutes or you will be removed.');
                                            ...
                                            API.sendChat("@" + name + ", you will be removed soon if you don't respond. [AFK]");
                                            user.afkWarningCount = 3;
                                            user.afkCountdown = setTimeout(function(userToChange){
                                            ...
                                            if(pos !== -1){
                                                ...
                                                API.sendChat('@' + name + ', you have been removed for being afk for ' + time + '. You were at position ' + pos + '. Chat at least once every ' + esBot.roomSettings.maximumAfk + ' minutes if you want to play a song.');
                                            }
                                            user.afkWarningCount = 0;
                                        };
                                    }
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.fbLink === "string")
                                        API.sendChat('/me [' + chat.from + '] Join us on Facebook: ' + esBot.roomSettings.fbLink);
                                };                              
                        },
                },
